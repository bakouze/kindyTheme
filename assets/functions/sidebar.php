...
function joints_register_sidebars() {
	register_sidebar(array(
		...
		'after_widget' => '</div>',
		'before_title' => '<div class="box"><h4 class="widgettitle">',
		'after_title' => '</h4><hr class="widgetHr"></div>',
	));
	...
	register_sidebar(array(
		...
		'description' => __('first footer sidebar.', 'jointswp'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4><hr class="footHr">',
	));

	register_sidebar(array(
		'id' => 'footer2',
		'name' => __('footer 2', 'jointswp'),
		'description' => __('second footer sidebar.', 'jointswp'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4><hr class="footHr">',
	...
	register_sidebar(array(
		...
		'description' => __('third footer sidebar.', 'jointswp'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4><hr class="footHr">',
